...
const i18n = {
    en: {
        ...
        action_chefeasy: "Explore the app",
        footer_games: "Games",
        ...
        tag_genvideo_mobile: "AI video generator",
        ...
        genvideo_mobile_desc: "The whole studio on a phone: write the brief, pick a template, and the app writes, draws, narrates and stitches. Finished videos play in the app and save to your gallery.",
        ...
        feat_genvideo_gallery: "Plays in the app, saves to your gallery",
        feat_genvideo_trial: "Two free videos, no account and no card",
        ...
        bksafe_desc: "An Android antivirus that scans apps and files with an on-device AI model, blocks scam calls, and watches network traffic — the analysis stays on the phone. There is a macOS build too, watching machine health, disk and network.",
        tag_bksafe_mac: "Mac security",
        bksafemac_desc: "A macOS app that watches the machine in real time — CPU, GPU, memory, the disk's SMART data, temperature and network traffic — and clears junk, scans for malware and audits security settings. Everything runs on the Mac.",
        ...
        feat_minicastle_loop: "Day, night, edict — twenty waves to survive",
        feat_minicastle_offline: "No ads, no purchases, nothing collected",
        action_minicastle: "Explore the game",
    ...
    es: {
        ...
        action_chefeasy: "Descubrir la app",
        footer_games: "Juegos",
        ...
        tag_genvideo_mobile: "Generador de vídeo con IA",
        ...
        genvideo_mobile_desc: "El estudio entero en el móvil: escribe el tema, elige una plantilla y la app redacta, dibuja, narra y monta. Los vídeos se reproducen dentro y se guardan en tu galería.",
        ...
        feat_genvideo_gallery: "Se reproduce en la app y se guarda en tu galería",
        feat_genvideo_trial: "Dos vídeos gratis, sin cuenta y sin tarjeta",
        ...
        bksafe_desc: "Un antivirus para Android que analiza apps y archivos con un modelo de IA en el propio dispositivo, bloquea llamadas fraudulentas y vigila el tráfico de red: el análisis nunca sale del teléfono. También hay una versión para macOS que vigila el estado del equipo, el disco y la red.",
        tag_bksafe_mac: "Seguridad para Mac",
        bksafemac_desc: "Una app de macOS que vigila el equipo en tiempo real — CPU, GPU, memoria, datos SMART del disco, temperatura y tráfico de red — y además limpia archivos basura, busca malware y audita la configuración de seguridad. Todo se ejecuta en el propio Mac.",
        ...
        feat_minicastle_loop: "Día, noche, edicto: veinte oleadas que sobrevivir",
        feat_minicastle_offline: "Sin anuncios, sin compras, sin recopilar nada",
        action_minicastle: "Descubre el juego",
    ...
    zh: {
        ...
        tag_genvideo_mobile: "AI 视频生成器",
        genvideo_desc: "输入一个主题，它逐个镜头撰写旁白、为每个镜头生成画面、朗读出来，套用 31 套模板之一，最后合成 MP4。支持 Windows、macOS 和 Linux，共九种语言。",
        genvideo_mobile_desc: "手机上的完整工作室：写下主题、选好模板，应用会撰写、绘制、配音并合成。成片可在应用内播放，也能保存到相册。",
        feat_genvideo_pipe: "脚本、画面、配音、音乐与合成，一次跑完",
        feat_genvideo_price: "每条视频一美元，两条免费试用，无需账号",
        feat_genvideo_gallery: "应用内播放，一键保存到相册",
        feat_genvideo_trial: "两条免费视频，无需账号，无需银行卡",
        action_genvideo: "获取 GenVideo",
        latest_genvideo: "输入一个主题，它撰写旁白、绘制每个镜头、朗读出来，并交给你一条成片。支持 Windows、macOS、Linux 和 Android。",
        tag_bksafe: "移动安全",
        bksafe_desc: "面向 Android 的杀毒应用：用设备端 AI 模型扫描应用与文件，拦截诈骗来电，并监控网络流量——分析全程在手机本地完成。另有 macOS 版本，可监测机器状态、磁盘与网络。",
        tag_bksafe_mac: "Mac 安全防护",
        bksafemac_desc: "一款 macOS 应用，实时监测机器状态——CPU、GPU、内存、磁盘 SMART 数据、温度与网络流量，同时清理垃圾、扫描恶意软件并审查安全配置。全部在本机完成。",
        ...
        feat_minicastle_loop: "白天、黑夜、敕令——二十波进攻要撑过去",
        feat_minicastle_offline: "无广告、无内购、不收集任何数据",
        action_minicastle: "了解这款游戏",
        tag_ironline: "塔防",
    ...
    hi: {
        ...
        tag_genvideo_mobile: "AI वीडियो जेनरेटर",
        ...
        genvideo_mobile_desc: "पूरा स्टूडियो फ़ोन में: विषय लिखिए, टेम्पलेट चुनिए, और ऐप लिखता, बनाता, बोलता और जोड़ता है। तैयार वीडियो ऐप में ही चलते हैं और गैलरी में सहेजे जाते हैं।",
        ...
        feat_genvideo_gallery: "ऐप में चलता है, गैलरी में सहेजा जाता है",
        feat_genvideo_trial: "दो मुफ़्त वीडियो, न खाता न कार्ड",
        ...
        bksafe_desc: "Android के लिए एंटीवायरस — डिवाइस पर ही चलने वाले AI मॉडल से ऐप्स और फ़ाइलों की जाँच करता है, ठगी वाली कॉल रोकता है और नेटवर्क ट्रैफ़िक पर नज़र रखता है। विश्लेषण फ़ोन से बाहर नहीं जाता। macOS के लिए भी एक संस्करण है, जो मशीन की सेहत, डिस्क और नेटवर्क पर नज़र रखता है।",
        tag_bksafe_mac: "Mac सुरक्षा",
        bksafemac_desc: "macOS के लिए एक ऐप जो मशीन पर लगातार नज़र रखता है — CPU, GPU, मेमोरी, डिस्क का SMART डेटा, तापमान और नेटवर्क ट्रैफ़िक — साथ ही जंक साफ़ करता है, मैलवेयर स्कैन करता है और सुरक्षा सेटिंग्स जाँचता है। सब कुछ Mac पर ही चलता है।",
        ...
        feat_minicastle_loop: "दिन, रात, फ़रमान — बीस लहरें जिन्हें झेलना है",
        feat_minicastle_offline: "कोई विज्ञापन नहीं, कोई ख़रीद नहीं, कोई डेटा नहीं",
        action_minicastle: "गेम देखें",
    ...
    ar: {
        ...
        action_chefeasy: "استكشف التطبيق",
        ...
        tag_genvideo_mobile: "مولّد فيديو بالذكاء الاصطناعي",
        ...
        genvideo_mobile_desc: "الاستوديو كله في الهاتف: اكتب الفكرة، اختر قالبًا، ويتولى التطبيق الكتابة والرسم والتعليق والتجميع. الفيديو الجاهز يُعرض داخل التطبيق ويُحفظ في معرض صورك.",
        ...
        feat_genvideo_gallery: "يُعرض داخل التطبيق ويُحفظ في معرضك",
        feat_genvideo_trial: "فيديوهان مجانًا، بلا حساب وبلا بطاقة",
        ...
        bksafe_desc: "تطبيق مكافحة فيروسات لأندرويد: يفحص التطبيقات والملفات بنموذج ذكاء اصطناعي يعمل على الجهاز، ويحجب مكالمات الاحتيال، ويراقب حركة الشبكة — ويبقى التحليل داخل الهاتف. وهناك أيضاً إصدار لـ macOS يراقب حالة الجهاز والقرص والشبكة.",
        tag_bksafe_mac: "حماية لأجهزة Mac",
        bksafemac_desc: "تطبيق macOS يراقب الجهاز لحظة بلحظة — المعالج وكرت الرسوم والذاكرة وبيانات SMART للقرص ودرجة الحرارة وحركة الشبكة — وينظف الملفات الزائدة ويفحص البرمجيات الخبيثة ويراجع إعدادات الأمان. كل ذلك يجري داخل الجهاز.",
        ...
        feat_minicastle_loop: "نهار، ليل، مرسوم — عشرون موجة عليك الصمود أمامها",
        feat_minicastle_offline: "بلا إعلانات، بلا مشتريات، وبلا جمع أي بيانات",
        action_minicastle: "استكشف اللعبة",
    ...
    pt: {
        ...
        action_chefeasy: "Explorar a app",
        footer_games: "Jogos",
        ...
        tag_genvideo_mobile: "Gerador de vídeo com IA",
        ...
        genvideo_mobile_desc: "O estúdio inteiro no telemóvel: escreva o tema, escolha um modelo, e a app redige, desenha, narra e monta. Os vídeos prontos tocam na app e guardam-se na sua galeria.",
        ...
        feat_genvideo_gallery: "Toca na app e guarda na sua galeria",
        feat_genvideo_trial: "Dois vídeos grátis, sem conta e sem cartão",
        ...
        bksafe_desc: "Um antivírus para Android que analisa apps e arquivos com um modelo de IA no próprio aparelho, bloqueia chamadas de golpe e acompanha o tráfego de rede — a análise não sai do celular. Há também uma versão para macOS que acompanha a saúde da máquina, o disco e a rede.",
        tag_bksafe_mac: "Segurança para Mac",
        bksafemac_desc: "Um app de macOS que acompanha a máquina em tempo real — CPU, GPU, memória, dados SMART do disco, temperatura e tráfego de rede — e ainda limpa arquivos inúteis, procura malware e audita as configurações de segurança. Tudo roda no próprio Mac.",
        ...
        feat_minicastle_loop: "Dia, noite, decreto — vinte ondas para sobreviver",
        feat_minicastle_offline: "Sem anúncios, sem compras, nada coletado",
        action_minicastle: "Conheça o jogo",
        tag_ironline: "Tower defense",
    ...
    fr: {
        ...
        action_chefeasy: "Découvrir l'application",
        footer_games: "Jeux",
        ...
        tag_genvideo_mobile: "Générateur de vidéo par IA",
        ...
        genvideo_mobile_desc: "Tout le studio sur un téléphone : écrivez le sujet, choisissez un modèle, et l’application rédige, dessine, raconte et assemble. Les vidéos se lisent dans l’app et s’enregistrent dans votre galerie.",
        ...
        feat_genvideo_gallery: "Se lit dans l’app, s’enregistre dans votre galerie",
        feat_genvideo_trial: "Deux vidéos gratuites, sans compte et sans carte",
        ...
        bksafe_desc: "Un antivirus Android qui analyse applications et fichiers avec un modèle d'IA embarqué, bloque les appels frauduleux et surveille le trafic réseau — l'analyse ne quitte jamais le téléphone. Il existe aussi une version macOS qui surveille l'état de la machine, le disque et le réseau.",
        tag_bksafe_mac: "Sécurité pour Mac",
        bksafemac_desc: "Une app macOS qui surveille la machine en temps réel — processeur, GPU, mémoire, données SMART du disque, température et trafic réseau — nettoie les fichiers inutiles, cherche les logiciels malveillants et audite les réglages de sécurité. Tout se passe sur le Mac.",
        ...
        feat_jemul_keys: "Un clavier de téléphone complet, à l'écran ou sur le vôtre",
        feat_jemul_web: 'Fonctionne aussi dans un onglet, sans rien installer',
        action_jemul: "Découvrir l'appli",
        tag_fortune: "Voyance",
        ...
        feat_minicastle_loop: "Jour, nuit, édit — vingt vagues à encaisser",
        feat_minicastle_offline: "Sans publicité, sans achats, aucune donnée collectée",
        action_minicastle: "Découvrir le jeu",
        tag_ironline: "Tower defense",
    ...
    de: {
        ...
        tag_genvideo_mobile: "KI-Videogenerator",
        ...
        genvideo_mobile_desc: "Das ganze Studio auf dem Handy: Thema eintippen, Vorlage wählen, und die App schreibt, zeichnet, spricht und schneidet. Fertige Videos laufen in der App und landen in deiner Galerie.",
        ...
        feat_genvideo_gallery: "Läuft in der App, speichert in deiner Galerie",
        feat_genvideo_trial: "Zwei Gratis-Videos, ohne Konto und ohne Karte",
        ...
        bksafe_desc: "Ein Android-Virenscanner, der Apps und Dateien mit einem KI-Modell direkt auf dem Gerät prüft, Betrugsanrufe blockiert und den Netzwerkverkehr im Blick behält – die Analyse bleibt auf dem Telefon. Es gibt außerdem eine macOS-Version, die Systemzustand, Laufwerk und Netzwerk im Blick behält.",
        tag_bksafe_mac: "Sicherheit für den Mac",
        bksafemac_desc: "Eine macOS-App, die den Rechner in Echtzeit beobachtet – CPU, GPU, Speicher, SMART-Werte der Platte, Temperatur und Netzwerkverkehr – dazu Datenmüll entfernen, nach Schadsoftware suchen und die Sicherheitseinstellungen prüfen. Alles läuft auf dem Mac selbst.",
        ...
        feat_minicastle_loop: "Tag, Nacht, Erlass — zwanzig Wellen zu überstehen",
        feat_minicastle_offline: "Keine Werbung, keine Käufe, keine Datenerfassung",
        action_minicastle: "Das Spiel ansehen",
        tag_ironline: "Tower-Defense",
    ...
    ja: {
        ...
        tag_genvideo_mobile: "AI 動画ジェネレーター",
        genvideo_desc: "テーマを入力すると、シーンごとにナレーションを書き、それぞれの絵を描き、読み上げ、31 種類のテンプレートに載せて MP4 に仕上げます。Windows・macOS・Linux 対応、9 言語。",
        genvideo_mobile_desc: "スタジオをまるごとスマホに。テーマを書いてテンプレートを選ぶだけで、執筆・作画・ナレーション・書き出しまで。完成した動画はアプリ内で再生でき、写真に保存できます。",
        feat_genvideo_pipe: "台本・作画・音声・音楽・書き出しを一度に",
        feat_genvideo_price: "1 本 1 ドル、2 本は無料、アカウント不要",
        feat_genvideo_gallery: "アプリ内で再生、写真に保存",
        feat_genvideo_trial: "無料 2 本、アカウントもカードも不要",
        ...
        bksafe_desc: "Android 向けのウイルス対策アプリ。端末内で動く AI モデルがアプリとファイルを検査し、詐欺電話を遮断し、通信を見張ります。解析はすべて端末内で完結します。macOS 版もあり、マシンの状態やディスク、ネットワークを見張ります。",
        tag_bksafe_mac: "Mac のセキュリティ",
        bksafemac_desc: "macOS 向けのアプリ。CPU、GPU、メモリ、ディスクの SMART 情報、温度、通信量をリアルタイムで見張り、不要ファイルの掃除、マルウェア検査、セキュリティ設定の点検まで行います。すべて Mac の中で完結します。",
        ...
        feat_minicastle_loop: "昼、夜、勅令 — 耐え抜くべき二十の波",
        feat_minicastle_offline: "広告なし、課金なし、データ収集もなし",
        action_minicastle: "ゲームを見る",
    ...
    ko: {
        ...
        tag_genvideo_mobile: "AI 영상 생성기",
        genvideo_desc: "주제를 입력하면 장면마다 내레이션을 쓰고, 각 장면의 그림을 그리고, 소리 내어 읽고, 31가지 템플릿 중 하나에 얹어 MP4로 만들어 냅니다. Windows·macOS·Linux, 9개 언어.",
        genvideo_mobile_desc: "스튜디오 전체를 휴대폰에. 주제를 적고 템플릿을 고르면 앱이 쓰고, 그리고, 읽고, 이어 붙입니다. 완성된 영상은 앱에서 재생되고 갤러리에 저장됩니다.",
        feat_genvideo_pipe: "대본·그림·음성·음악·합치기를 한 번에",
        feat_genvideo_price: "영상당 1달러, 2편 무료, 계정 불필요",
        feat_genvideo_gallery: "앱에서 재생하고 갤러리에 저장",
        feat_genvideo_trial: "무료 영상 2편, 계정도 카드도 필요 없음",
        action_genvideo: "GenVideo 받기",
        latest_genvideo: "주제를 입력하면 내레이션을 쓰고, 모든 장면을 그리고, 읽어 주고, 완성된 영상을 건네줍니다. Windows·macOS·Linux·Android.",
        tag_bksafe: "모바일 보안",
        bksafe_desc: "Android용 백신 앱입니다. 기기 안에서 동작하는 AI 모델로 앱과 파일을 검사하고, 사기 전화를 차단하며, 네트워크 사용량을 지켜봅니다. 분석은 모두 휴대폰 안에서 이뤄집니다. 머신 상태와 디스크, 네트워크를 지켜보는 macOS 버전도 있습니다.",
        tag_bksafe_mac: "Mac 보안",
        bksafemac_desc: "macOS 앱으로 CPU, GPU, 메모리, 디스크 SMART 정보, 온도, 네트워크 사용량을 실시간으로 지켜보고 불필요한 파일 정리, 악성코드 검사, 보안 설정 점검까지 해냅니다. 모든 작업은 Mac 안에서 이뤄집니다.",
        ...
        feat_minicastle_loop: "낮, 밤, 칙령 — 버텨야 할 스무 번의 웨이브",
        feat_minicastle_offline: "광고 없음, 결제 없음, 수집하는 데이터 없음",
        action_minicastle: "게임 보기",
        tag_ironline: "타워 디펜스",
    ...
    ru: {
        ...
        action_chefeasy: "Открыть приложение",
        footer_games: "Игры",
        ...
        tag_genvideo_mobile: "ИИ-генератор видео",
        ...
        genvideo_mobile_desc: "Вся студия в телефоне: впишите тему, выберите шаблон — приложение напишет, нарисует, озвучит и смонтирует. Готовые видео играют внутри приложения и сохраняются в галерею.",
        ...
        feat_genvideo_gallery: "Играет в приложении, сохраняется в галерею",
        feat_genvideo_trial: "Два бесплатных видео, без аккаунта и без карты",
        ...
        bksafe_desc: "Антивирус для Android: проверяет приложения и файлы ИИ-моделью прямо на устройстве, блокирует мошеннические звонки и следит за сетевым трафиком — анализ не покидает телефон. Есть и версия для macOS, которая следит за состоянием машины, диска и сети.",
        tag_bksafe_mac: "Безопасность для Mac",
        bksafemac_desc: "Приложение для macOS следит за машиной в реальном времени — процессор, видеокарта, память, SMART-данные диска, температура и сетевой трафик, — а ещё чистит мусор, ищет вредоносное ПО и проверяет настройки безопасности. Всё работает прямо на Mac.",
        ...
        feat_minicastle_loop: "День, ночь, указ — двадцать волн, которые надо выдержать",
        feat_minicastle_offline: "Без рекламы, без покупок, без сбора данных",
        action_minicastle: "Посмотреть игру",
    ...
    vi: {
        ...
        action_chefeasy: "Khám phá ứng dụng",
        ...
        tag_genvideo_mobile: "Tạo video bằng AI",
        ...
        genvideo_mobile_desc: "Cả phòng dựng gói trong điện thoại: gõ chủ đề, chọn mẫu, ứng dụng lo phần viết, vẽ, đọc và ghép. Video xong phát ngay trong ứng dụng và lưu vào thư viện ảnh.",
        ...
        feat_genvideo_gallery: "Phát trong ứng dụng, lưu vào thư viện ảnh",
        feat_genvideo_trial: "Hai video miễn phí, không tài khoản, không thẻ",
        ...
        bksafe_desc: "Ứng dụng diệt virus cho Android: quét ứng dụng và tệp bằng mô hình AI chạy ngay trên máy, chặn cuộc gọi lừa đảo và theo dõi lưu lượng mạng — dữ liệu phân tích không rời khỏi điện thoại. Ngoài ra còn có bản macOS theo dõi sức khoẻ máy, ổ đĩa và mạng.",
        tag_bksafe_mac: "Bảo mật máy Mac",
        bksafemac_desc: "Ứng dụng macOS theo dõi máy theo thời gian thực — CPU, GPU, bộ nhớ, chỉ số SMART của ổ, nhiệt độ và lưu lượng mạng — kèm dọn rác, quét mã độc và rà soát cấu hình bảo mật. Mọi thứ chạy ngay trên máy.",
        ...
        feat_minicastle_loop: "Ngày, đêm, sắc lệnh — hai mươi đợt phải sống sót",
        feat_minicastle_offline: "Không quảng cáo, không mua bán, không thu thập gì",
        action_minicastle: "Xem trò chơi",
