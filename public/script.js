...
const i18n = {
    en: {
        ...
        tag_locallex: "Offline legal reference",
        latest_locallex: "Full-text search across 49,165 Vietnamese legal documents and the relations between them, entirely on your own machine. Android, and now Linux.",
        action_locallex: "Get LocalLex",
    ...
    es: {
        ...
        tag_locallex: "Consulta legal sin conexión",
        latest_locallex: "Búsqueda de texto completo en 49.165 documentos jurídicos vietnamitas y en las relaciones entre ellos, todo en tu propio equipo. Android y ahora Linux.",
        action_locallex: "Descargar LocalLex",
    ...
    zh: {
        ...
        tag_locallex: "离线法律查询",
        latest_locallex: "在自己的设备上全文检索 49,165 份越南法律文件及其相互关系。支持 Android，现已支持 Linux。",
        action_locallex: "获取 LocalLex",
    ...
    hi: {
        ...
        tag_locallex: "ऑफ़लाइन कानूनी संदर्भ",
        latest_locallex: "49,165 वियतनामी कानूनी दस्तावेज़ों और उनके आपसी संबंधों में पूर्ण-पाठ खोज, पूरी तरह आपके अपने डिवाइस पर। Android, और अब Linux।",
        action_locallex: "LocalLex पाएँ",
    ...
    ar: {
        ...
        tag_locallex: "مرجع قانوني دون اتصال",
        latest_locallex: "بحث في النص الكامل عبر 49,165 وثيقة قانونية فيتنامية وفي العلاقات بينها، بالكامل على جهازك. لنظام Android، والآن Linux.",
        action_locallex: "احصل على LocalLex",
    ...
    pt: {
        ...
        tag_locallex: "Consulta jurídica offline",
        latest_locallex: "Pesquisa em texto integral de 49 165 documentos jurídicos vietnamitas e das relações entre eles, tudo na sua própria máquina. Android e agora Linux.",
        action_locallex: "Baixar o LocalLex",
    ...
    fr: {
        ...
        tag_locallex: "Référence juridique hors ligne",
        latest_locallex: "Recherche en texte intégral dans 49 165 textes juridiques vietnamiens et dans les liens qui les unissent, entièrement sur votre machine. Android, et désormais Linux.",
        action_locallex: "Obtenir LocalLex",
    ...
    de: {
        ...
        tag_locallex: "Rechtsrecherche offline",
        latest_locallex: "Volltextsuche in 49.165 vietnamesischen Rechtstexten und in ihren Verweisen untereinander — vollständig auf dem eigenen Rechner. Android und jetzt Linux.",
        action_locallex: "LocalLex holen",
    ...
    ja: {
        ...
        tag_locallex: "オフライン法令検索",
        latest_locallex: "49,165 件のベトナム法令とその相互関係を、端末の中だけで全文検索。Android に加えて Linux にも対応。",
        action_locallex: "LocalLex を入手",
    ...
    ko: {
        ...
        tag_locallex: "오프라인 법령 검색",
        latest_locallex: "베트남 법령 49,165건과 법령 사이의 관계를 기기 안에서만 전문 검색. Android에 이어 Linux도 지원.",
        action_locallex: "LocalLex 받기",
    ...
    ru: {
        ...
        tag_locallex: "Правовой справочник офлайн",
        latest_locallex: "Полнотекстовый поиск по 49 165 вьетнамским правовым актам и связям между ними — целиком на вашем устройстве. Android, а теперь и Linux.",
        action_locallex: "Установить LocalLex",
    ...
    vi: {
        ...
        tag_locallex: "Tra cứu pháp luật ngoại tuyến",
        latest_locallex: "Tìm toàn văn 49.165 văn bản quy phạm pháp luật Việt Nam và quan hệ giữa chúng, hoàn toàn trên máy của bạn. Có bản Android, nay có cả Linux.",
        action_locallex: "Tải LocalLex",
