...
const i18n = {
    ...
    vi: {
        ...
        gen_sub: "Mỗi tầng đều được dựng mới, các phòng nối nhau sang trái, sang phải, lên và xuống — nên một tầng là khoảng không để di chuyển, không phải một đường thẳng để đi hết.",
        g_tree_t: "Phòng nối theo cả bốn hướng",
        g_tree_d: "Các phòng nằm cạnh nhau và chồng lên nhau, nên một tầng vừa trải rộng vừa dâng cao. Cửa hông nối các phòng cùng hàng; giếng đứng có sàn xuyên qua và các gờ so le nối lên xuống giữa các tầng phòng.",
        g_braid_t: "Vòng lặp và ngõ cụt, không phải một tuyến duy nhất",
        g_braid_d: "Có thêm những lối nối phụ giữa các phòng nên một tầng không bao giờ chỉ là một hành lang. Càng xuống sâu, tầng càng mở ra thành khoảng không để di chuyển thay vì một tuyến đường định sẵn.",
        ...
        g_pit_t: "Hố là chết, và hố nào cũng nhảy qua được",
        g_pit_d: "Rơi vào chông hay lửa là chết ngay tại chỗ, với bạn và với cả thứ đang đuổi theo. Không hố nào rộng quá một cú nhảy, và không lối đi nào bắt bạn phải bước qua ô gây chết.",
        g_proof_t: "Mọi tầng đều chắc chắn đi hết được",
        g_proof_d: "Không tầng nào đến tay bạn mà chưa được kiểm tra trọn vẹn: chìa khoá phải lấy được khi cổng còn khoá, cổng dịch chuyển phải tới được khi đã mở, và không phòng nào bị bịt kín. Bố cục nào không đạt sẽ bị bỏ và dựng lại.",
        g_audit_t: "Và mọi tầng đều được cân nhịp độ",
        g_audit_d: "Cả trăm tầng đều được rà lại xem một lượt chơi sạch sẽ diễn ra thế nào. Tầng nào lê thê, tầng nào giết quá nhanh hoặc dồn quá đông quái vào một phòng đều bị dựng lại trước khi đến tay bạn.",
        ...
        l_rhythm_d: "Các đòn của lãnh chúa được giãn ra ở đầu trận chứ không dồn hết cùng lúc, và khoảng nghỉ giữa chúng ngắn dần khi trận đánh kéo dài. Đứng lì trên gờ đá chỉ khiến cú nhảy tới sớm hơn.",
        l_size_t: "Kích cỡ suy ra từ máu",
        l_size_d: "Nhìn to tới đâu là chịu đòn tới đó, và cách đọc ấy đúng với mọi kẻ địch trong game. Hai mươi lãnh chúa, mỗi kẻ có kích thước, màu sắc, máu, tầm với, loạt đạn và tiếng gầm riêng.",
        l_arena_t: "Bốn kiểu đấu trường",
        l_arena_d: "Đấu trường có bốn kiểu bố trí gờ đá dài dần, nên hai mươi trận không diễn ra trong cùng một gian phòng chỉ đổi màu. Mọi gờ đá đều nằm trong tầm một cú nhảy đúp.",
        ...
        p_wide: "<strong>Màn hình dài cho tầm nhìn rộng hơn, không phải viền đen.</strong> Khung nhìn giữ nguyên chiều cao và nới rộng ra cho vừa máy, còn HUD tự neo lại khi xoay màn hình.",
        p_pixel: "<strong>Pixel nguyên trên máy thật.</strong> Ở các độ phân giải điện thoại phổ biến, hình được phóng theo bội số nguyên nên không bị nhoè do nội suy lại.",
        ...
        gal_sub: "Mọi khung hình ở đây đều chụp thẳng từ bản dựng đang chạy, ở độ phân giải đầy đủ.",
        ...
        faq1_a: "Android 7.0 trở lên, trên arm64-v8a và armeabi-v7a. Google Play tách gói theo từng máy, nên điện thoại chỉ tải khoảng một phần ba cả bản dựng.",
        ...
        faq4_a: "Được. Phím bàn phím và tay cầm đều là công dân hạng nhất, còn nút cảm ứng có thể tắt hẳn ở <em>Options → Touch pad</em>. Hình được phóng theo bội số pixel nguyên nên vẫn sắc nét trên máy cầm tay hay máy bàn.",
