...
const i18n = {
    vi: {
        ...
        meta_desc: "BKSafe theo dõi sức khoẻ máy, quét mã độc, dọn rác và canh lưu lượng mạng. Bản macOS 1.2.8 và bản Windows 1.3.0 tải trực tiếp, bản Android và bản Lite cho máy yếu trên Google Play.",
        ...
        hero_meta: "macOS 1.2.8 · 29 MB · universal cho Intel và Apple Silicon. Windows 1.3.0 · 20 MB · chạy ngay, không cần cài. Linux 1.3.0 · 15 MB · gói .deb cho Debian và Ubuntu.",
    ...
    en: {
        ...
        meta_desc: "BKSafe watches machine health, scans for malware, clears junk and keeps an eye on network traffic. macOS 1.2.8 and Windows 1.3.0 as direct downloads, Android and the lightweight Lite build on Google Play.",
        nav_policy: "Privacy",
        ...
        hero_meta: "macOS 1.2.8 · 29 MB · universal for Intel and Apple Silicon. Windows 1.3.0 · 20 MB · runs straight out of the folder. Linux 1.3.0 · 15 MB · .deb for Debian and Ubuntu.",
