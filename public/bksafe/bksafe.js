...
const i18n = {
    vi: {
        ...
        hero_meta: "macOS 1.2.8 · 29 MB · universal cho Intel và Apple Silicon. Windows 1.3.0 · 20 MB · chạy ngay, không cần cài.",
        ...
        faq_5_a: "Trên Mac chạy <code>shasum -a 256 BKSafe-1.2.8.dmg</code>; trên Windows mở PowerShell rồi chạy <code>Get-FileHash BKSafe-1.3.0-win-x64-portable.zip -Algorithm SHA256</code>. So kết quả với chuỗi SHA-256 đăng ở mục Tải về — trùng nhau nghĩa là tệp còn nguyên vẹn.",
    ...
    en: {
        ...
        hero_meta: "macOS 1.2.8 · 29 MB · universal for Intel and Apple Silicon. Windows 1.3.0 · 20 MB · runs straight out of the folder.",
        ...
        faq_5_a: "On a Mac run <code>shasum -a 256 BKSafe-1.2.8.dmg</code>; on Windows open PowerShell and run <code>Get-FileHash BKSafe-1.3.0-win-x64-portable.zip -Algorithm SHA256</code>. Compare the result with the SHA-256 published in the Download section — matching strings mean the file is intact.",
