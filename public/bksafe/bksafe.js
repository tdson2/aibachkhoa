...
const i18n = {
    vi: {
        ...
        hero_meta: "macOS 1.3.0 · 29 MB · universal cho Intel và Apple Silicon. Windows 1.3.0 · 20 MB · chạy ngay, không cần cài. Linux 1.3.0 · 15 MB · gói .deb cho Debian và Ubuntu.",
        ...
        mac_badge_ver: "Phiên bản 1.3.0 · build 23",
        ...
        step_1: "Tải tệp <code>BKSafe-1.3.0.dmg</code> về máy.",
        ...
        dl_mac_btn: "Tải BKSafe-1.3.0.dmg (29 MB)",
        dl_droid_line: "Cài qua Google Play · tự động cập nhật",
        play_small: "TẢI VỀ TRÊN",
        spec_file: "Tên tệp",
        spec_size: "Kích cỡ",
        spec_ver: "Phiên bản", spec_ver_v: "1.3.0 (build 23)",
        ...
        sha_copy: "Sao chép",
        sha_copied: "Đã chép",
        sha_hint: "Đối chiếu bằng <code>shasum -a 256 BKSafe-1.3.0.dmg</code>, hoặc dùng luôn <a href=\"/downloads/BKSafe-1.3.0.dmg.sha256\" download>tệp .sha256 kèm theo</a>.",
        ...
        pick_linux_go: "Xem bản Linux 1.3.0",
        ...
        linux_badge_ver: "Phiên bản 1.3.0 · build 23",
        ...
        spec_install_linux: "Bấm đúp vào tệp, hoặc chạy <code>sudo apt install ./BKSafe-1.3.0-linux-amd64.deb</code>",
        spec_sign_linux: "Chưa ký — đối chiếu bằng mã SHA-256 bên dưới",
        sha_hint_linux: "Đối chiếu bằng <code>sha256sum BKSafe-1.3.0-linux-amd64.deb</code>, hoặc dùng luôn <a href=\"/downloads/BKSafe-1.3.0-linux-amd64.deb.sha256\" download>tệp .sha256 kèm theo</a>.",
        linux_steps_title: "Cài trong ba bước",
        linux_step_1: "Tải tệp <code>BKSafe-1.3.0-linux-amd64.deb</code> về.",
        linux_step_2: "Bấm đúp vào tệp để mở trình cài đặt phần mềm, hoặc chạy <code>sudo apt install ./BKSafe-1.3.0-linux-amd64.deb</code> trong cửa sổ dòng lệnh.",
        ...
        faq_5_a: "Trên Mac chạy <code>shasum -a 256 BKSafe-1.3.0.dmg</code>; trên Windows mở PowerShell rồi chạy <code>Get-FileHash BKSafe-1.3.0-win-x64-portable.zip -Algorithm SHA256</code>; trên Linux chạy <code>sha256sum BKSafe-1.3.0-linux-amd64.deb</code>. So kết quả với chuỗi SHA-256 đăng ở mục Tải về — trùng nhau nghĩa là tệp còn nguyên vẹn.",
    ...
    en: {
        ...
        hero_meta: "macOS 1.3.0 · 29 MB · universal for Intel and Apple Silicon. Windows 1.3.0 · 20 MB · runs straight out of the folder. Linux 1.3.0 · 15 MB · .deb for Debian and Ubuntu.",
        ...
        mac_badge_ver: "Version 1.3.0 · build 23",
        ...
        step_1: "Download <code>BKSafe-1.3.0.dmg</code>.",
        ...
        dl_mac_btn: "Download BKSafe-1.3.0.dmg (29 MB)",
        dl_droid_line: "Installed via Google Play · updates itself",
        play_small: "GET IT ON",
        spec_file: "File name",
        spec_size: "Size",
        spec_ver: "Version", spec_ver_v: "1.3.0 (build 23)",
        ...
        sha_copy: "Copy",
        sha_copied: "Copied",
        sha_hint: "Check it with <code>shasum -a 256 BKSafe-1.3.0.dmg</code>, or use the <a href=\"/downloads/BKSafe-1.3.0.dmg.sha256\" download>.sha256 file</a> alongside it.",
        ...
        pick_linux_go: "See the Linux 1.3.0 build",
        ...
        linux_badge_ver: "Version 1.3.0 · build 23",
        ...
        spec_install_linux: "Double-click the file, or <code>sudo apt install ./BKSafe-1.3.0-linux-amd64.deb</code>",
        spec_sign_linux: "Not signed — verify with the SHA-256 below",
        sha_hint_linux: "Check it with <code>sha256sum BKSafe-1.3.0-linux-amd64.deb</code>, or use the <a href=\"/downloads/BKSafe-1.3.0-linux-amd64.deb.sha256\" download>.sha256 file</a> alongside it.",
        linux_steps_title: "Installing it in three steps",
        linux_step_1: "Download <code>BKSafe-1.3.0-linux-amd64.deb</code>.",
        linux_step_2: "Double-click it to open your software installer, or run <code>sudo apt install ./BKSafe-1.3.0-linux-amd64.deb</code> in a terminal.",
        ...
        faq_5_a: "On a Mac run <code>shasum -a 256 BKSafe-1.3.0.dmg</code>; on Windows open PowerShell and run <code>Get-FileHash BKSafe-1.3.0-win-x64-portable.zip -Algorithm SHA256</code>; on Linux run <code>sha256sum BKSafe-1.3.0-linux-amd64.deb</code>. Compare the result with the SHA-256 published in the Download section — matching strings mean the file is intact.",
