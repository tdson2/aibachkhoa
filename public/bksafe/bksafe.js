...
const i18n = {
    vi: {
        ...
        pol_summary_1: "BKSafe là bộ công cụ bảo vệ và tối ưu máy, do AIBachKhoa (Son Tran), Việt Nam phát hành. Có bốn bản: Windows, macOS, Linux và Android.",
        ...
        pol_net_clam_t: "Dịch vụ cập nhật chữ ký virus",
        ...
        hero_meta: "macOS 1.3.2 · 33 MB · universal cho Intel và Apple Silicon. Windows 1.3.0 · 20 MB · chạy ngay, không cần cài. Linux 1.3.1 · 15 MB · gói .deb cho Debian và Ubuntu.",
        ...
        pick_mac_desc: "Theo dõi và bảo trì trong một ứng dụng: sức khoẻ hệ thống, dọn rác, quét mã độc, rà soát bảo mật, sức khoẻ ổ đĩa, nhiệt độ, hoạt động mạng và cảnh báo bất thường.",
        pick_mac_go: "Xem bản macOS 1.3.2",
        pick_win_kicker: "Ứng dụng máy tính",
        pick_win_desc: "Dọn rác, đo dung lượng và bộ nhớ, quét virus, chống mã hoá tống tiền, kiểm tra an toàn hệ thống, dịch vụ nền, hoạt động mạng, sức khoẻ ổ cứng và giám sát.",
        pick_win_go: "Xem bản Windows 1.3.0",
        pick_droid_kicker: "Ứng dụng di động",
        pick_droid_desc: "Quét ứng dụng và tệp ngay trên máy, chặn cuộc gọi lừa đảo, két bảo mật khoá bằng mã PIN và điểm an toàn cho cả máy. Máy đời cũ đã có bản BKSafe Lite.",
        pick_droid_go: "Xem bản Android",

        mac_eyebrow: "Bản macOS",
        mac_title: "Chiếc Mac của bạn, đo toàn diện.",
        mac_sub: "Số liệu trực tiếp của mọi thành phần trên máy trong cùng một nơi — bộ xử lý, đồ hoạ, bộ nhớ, lưu trữ, sức khoẻ ổ đĩa, nhiệt độ và mạng — cùng với dọn rác, quét mã độc và rà soát bảo mật.",
        ...
        f_gpu_t: "GPU",
        f_gpu_d: "Mức bận, hoạt động dựng hình và chia mảnh, bộ nhớ đồ hoạ đang chiếm so với hạn mức, và số nhân.",
        f_mem_t: "Bộ nhớ",
        ...
        f_disk_d: "Sức khoẻ ổ đĩa trong một màn: mức hao mòn, dung lượng dự phòng, tổng dữ liệu đã ghi, số lần tắt đột ngột, lỗi đọc ghi và nhiệt độ ổ.",
        f_temp_t: "Nhiệt độ",
        ...
        f_mon_d: "Cảnh báo khi một chỉ số duy trì ngoài phạm vi dự kiến. Ngưỡng do bạn đặt, nên những dao động thông thường không bị báo là sự cố.",
        f_clean_t: "Dọn rác",
        ...
        f_scan_d: "Rà các vị trí mã độc thường nhắm tới cùng mọi thứ khởi động cùng máy, đối chiếu với kho dữ liệu mối nguy được cập nhật.",
        ...
        gal_sub: "Ảnh chụp thực tế từ bản macOS.",
        ...
        s10_cap: "Sức khoẻ ổ đĩa, hoạt động đọc ghi và cách dung lượng được bố trí trên ổ.",
        ...
        s13_cap: "Chỉ cảnh báo khi một chỉ số duy trì ngoài phạm vi bình thường.",
        ...
        note_body: "BKSafe hiển thị thông tin phần cứng, lưu trữ, mạng và cấu hình an toàn nằm ngoài vùng chứa riêng của ứng dụng, đồng thời dọn các tệp thừa rải rác trong hệ thống. Việc đó cần quyền Toàn quyền truy cập ổ đĩa, và cũng là lý do BKSafe phát hành qua Developer ID có công chứng Apple thay vì qua Mac App Store. Quyền này chỉ dùng để đọc, và không có gì được gửi ra ngoài.",
        ...
        win_sub: "Cùng một BKSafe, dựng riêng cho Windows: dọn rác, đo dung lượng và bộ nhớ, quét virus, chống mã hoá tống tiền, rà soát dịch vụ nền, hoạt động mạng và cảnh báo khi một chỉ số vượt ngưỡng. Không có bộ cài — giải nén ra là chạy.",
        ...
        w_storage_d: "Thư mục nào, tệp nào đang chiếm chỗ. Xem theo thư mục, theo tệp lớn nhất hoặc theo loại tệp.",
        w_mem_t: "Bộ nhớ",
        w_mem_d: "RAM đang đi đâu và tiến trình nào đang giữ nó, kèm phần đệm tệp có thể nhả ra khi máy cần.",
        w_scan_t: "Quét virus",
        w_scan_d: "Quét theo nội dung tệp trên những thư mục bạn chọn, đối chiếu với kho dữ liệu mối nguy được cập nhật.",
        w_guard_t: "Chống mã hoá hàng loạt",
        w_guard_d: "Bảo vệ dựa trên hành vi, phát hiện việc mã hoá hàng loạt tài liệu ngay khi đang diễn ra và cảnh báo tức thì.",
        ...
        w_svc_d: "Cái gì đang chạy nền dưới quyền hệ thống, ai ký và nằm ở đâu, dịch vụ mới cài được hiện ra ngay.",
        w_net_t: "Mạng",
        ...
        w_mon_t: "Giám sát",
        w_mon_d: "Toàn bộ máy trong một màn hình, kèm nhật ký mọi cảnh báo đã phát. Chỉ cảnh báo khi một chỉ số nằm ngoài ngưỡng bạn đặt.",
        w_hist_t: "Nhật ký quét",
        w_hist_d: "Mỗi lượt quét đều được ghi lại: chạy lúc nào, phạm vi nào và thấy gì. Lượt bị dừng giữa chừng cũng được ghi, nên nhật ký là đầy đủ.",
        w_sched_t: "Quét định kỳ",
        w_sched_d: "Quét hằng ngày, hằng tuần hoặc hằng tháng, tự chạy, và luôn hiển thị thời điểm của lượt kế tiếp.",
        w_auto_t: "Khởi động cùng máy",
        w_auto_d: "Cho BKSafe khởi động cùng Windows để các lớp bảo vệ nền hoạt động ngay từ lúc đăng nhập. Mục khởi động được tạo trong phần của riêng tài khoản bạn, không cần quyền quản trị.",
        w_hud_t: "Cửa sổ thu gọn",
        w_hud_d: "Thu ứng dụng thành một bảng nhỏ gọn trên màn hình với vài chỉ số trực tiếp, kèm chỉ báo khi có việc cần bạn xử lý.",
        ...
        win_steps_foot: "Chép cả thư mục đi đâu cũng chạy — ổ USB, ổ mạng hay một máy khác; chỉ cần giữ nguyên các thành phần trong thư mục. Cài đặt của bạn nằm ở <code>%APPDATA%\\BKSafe\\BKSafe</code>, nên xoá thư mục ứng dụng cũng không mất. Ứng dụng chưa có chứng chỉ ký mã, nên lần mở đầu có thể hiện bảng SmartScreen màu xanh — bấm <strong>More info</strong> rồi <strong>Run anyway</strong>.",

        droid_eyebrow: "Bản Android",
        droid_title: "Chiếc điện thoại tự lo được cho mình.",
        droid_sub: "Ứng dụng và tệp được kiểm tra ngay trên máy, cuộc gọi lừa đảo bị chặn trước khi chuông reo, và dữ liệu riêng tư nằm sau mã PIN. Không bước nào cần tới máy chủ.",
        droid_badge_store: "Có trên Google Play",
        droid_badge_free: "Miễn phí tải về",
        droid_badge_vi: "Giao diện tiếng Việt",
        d_scan_t: "Quét nhanh ngay trên máy",
        d_scan_d: "Một chạm là kiểm tra toàn bộ ứng dụng đã cài và tệp trên máy. Việc phân tích chạy ngay trên thiết bị nên không cần kết nối mạng.",
        ...
        lite_sub: "BKSafe Lite dành cho máy đời cũ và cấu hình thấp: không có dịch vụ chạy nền, và một bộ công cụ gọn được truy cập thẳng từ màn hình chính.",
        lite_f1_t: "Quét tệp",
        lite_f1_d: "Kiểm tra tệp bằng kho chữ ký lưu sẵn trên máy — không cần kết nối mạng.",
        ...
        lite_note: "Soi dịch vụ nền, theo dõi lưu lượng, két mật khẩu và điểm an toàn có trong bản BKSafe đầy đủ.",
        ...
        pick_linux_desc: "Dọn rác, đo dung lượng và bộ nhớ, quét virus, bảo vệ thời gian thực, kiểm tra an toàn hệ thống, rà soát dịch vụ, hoạt động mạng, sức khoẻ ổ cứng và nhiệt độ.",
        pick_linux_go: "Xem bản Linux 1.3.1",
        linux_eyebrow: "Bản Linux",
        linux_title: "Máy Linux của bạn, đo toàn diện.",
        linux_sub: "Cùng một BKSafe, dựng riêng cho Linux: dọn rác, đo dung lượng và bộ nhớ, quét virus, bảo vệ thời gian thực với tệp mới xuất hiện, rà soát dịch vụ, sức khoẻ ổ cứng, nhiệt độ và hoạt động mạng. Cài bằng gói .deb chuẩn và gỡ sạch.",
        ...
        spec_req_linux: "Debian 12, Ubuntu 22.04 trở lên",
        ...
        linux_steps_foot: "Gói cài sẽ bổ sung những thành phần phụ thuộc còn thiếu, thêm mục vào trình đơn ứng dụng và gỡ sạch bằng <code>sudo apt remove bksafe</code>. Cài đặt của bạn nằm trong <code>~/.config</code> và <code>~/.local/share/bksafe</code>, nên gỡ gói cũng không mất. Một vài chỉ số cần công cụ hệ thống tuỳ chọn; nếu máy không có, ứng dụng báo là không đọc được thay vì đưa ra con số ước lượng.",
        dl_win_btn: "Tải gói Windows portable (20 MB)",
        dl_lite_line: "Cài qua Google Play · dành cho máy yếu",
        dl_lite_foot: "Quét tệp, dọn rác, kiểm tra pin và đo tốc độ mạng, không có dịch vụ chạy nền — giữ cho máy đời cũ nhẹ nhàng.",
        ...
        faq_2_a: "Ứng dụng trên Mac App Store buộc phải chạy trong hộp cát, và hộp cát chặn quyền truy cập tới thông tin phần cứng, lưu trữ và hệ thống mà BKSafe hiển thị. Vì vậy BKSafe phát hành qua Developer ID có công chứng Apple.",
        faq_3_q: "Mở lên có bị macOS chặn không?",
        faq_3_a: "Không. Bản macOS được ký bằng Developer ID và đã qua công chứng của Apple, vé công chứng đóng thẳng vào cả tệp DMG lẫn ứng dụng bên trong. Bạn chỉ cần kéo vào Applications rồi mở như mọi ứng dụng khác, kể cả lúc máy không có mạng.",
        ...
        faq_w1_a: "Không. Đây là gói chạy ngay: giải nén vào một thư mục rồi bấm đúp <code>bksafe.exe</code>. Chép cả thư mục sang ổ USB hay máy khác vẫn chạy — chỉ cần giữ nguyên các thành phần trong thư mục. Cài đặt được lưu riêng ở <code>%APPDATA%\\BKSafe\\BKSafe</code>.",
        ...
        faq_lite_a: "BKSafe Lite (<code>com.tdson.bksafelite</code>) gồm quét tệp, dọn rác, kiểm tra pin và đo tốc độ mạng. Bản này không chạy dịch vụ nền nên nhẹ với máy đời cũ. Chặn cuộc gọi lừa đảo, soi dịch vụ nền, két bảo mật và điểm an toàn nằm ở bản BKSafe đầy đủ. Đây là hai ứng dụng riêng, bạn có thể cài cùng lúc.",
        ...
        pr_sub: "Quét, cách ly, dọn dẹp và mọi chỉ số trực tiếp đều miễn phí trên mọi nền tảng. Bản Pro bổ sung những gì không thể làm thủ công: bảo vệ vẫn chạy khi bạn không có mặt, và nhật ký lưu lâu hơn.",
        pr_free_name: "Miễn phí",
        pr_free_amount: "0₫",
        pr_free_note: "Mãi mãi, trên mọi nền tảng.",
        pr_free_1: "Quét tệp theo yêu cầu với kho dữ liệu mối nguy đầy đủ",
    ...
    en: {
        ...
        hero_meta: "macOS 1.3.2 · 33 MB · universal for Intel and Apple Silicon. Windows 1.3.0 · 20 MB · runs straight out of the folder. Linux 1.3.1 · 15 MB · .deb for Debian and Ubuntu.",
        ...
        pick_mac_go: "See the macOS 1.3.2 build",
