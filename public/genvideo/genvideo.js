...
const i18n = {
    en: {
        ...
        hero_sub: "GenVideo writes the narration, draws every scene, reads it aloud and lays it over a template — then hands you an MP4. You bring the idea; it handles everything in between. Runs on Windows, macOS, Linux and Android.",
        ...
        how_title: "Everything between an idea and a finished file.",
        how_sub: "Every render follows the same route, and the queue reports the stage it has reached rather than showing a bar that means nothing.",
        ...
        step2_d: "The topic becomes scene-by-scene narration, inside the word range you set.",
        step3_t: "Set the visual direction",
        step3_d: "Each scene gets artwork direction of its own, with your style applied throughout so the whole video looks like one piece.",
        step4_t: "Generate the artwork",
        step4_d: "One image per scene. A hosted image service or one of your own — which it uses is a setting, not a different build.",
        ...
        feat_title: "Made for people who publish.",
        ...
        f_player_d: "Finished renders open in a built-in player with a scrub bar, without leaving the app.",
        f_save_t: "Saves where you look for it",
        f_save_d: "On a phone the video lands in the gallery; on a desktop it lands in Downloads — where you would look for it.",
        f_studio_t: "AI Studio bench",
        f_studio_d: "Try one capability at a time — narration, titles, artwork direction, a single image, a voice line — before committing a whole render to a setting.",
        f_queue_t: "A queue with the full record",
        f_queue_d: "Elapsed time, output size, duration, and the request that produced it. When a job fails, the reason is shown.",
        ...
        desk_badge_linux: "Linux — Debian and Ubuntu based",
        desk_badge_pay: "Pays through PayPal",
        desk_1_t: "Everything about the render, on one screen",
        desk_1_d: "Five numbered blocks walk from source text to a queued job. The build sheet on the right keeps a running summary and will not launch until the request is valid, so a render does not fail for something the form could already see.",
        ...
        desk_2_d: "Every job that has ever run, with what it produced and what it was asked to produce. A running job shows elapsed time; completion is reported by the renderer itself rather than estimated as a percentage.",
        desk_2_l1: "Filter by active, completed, failed or cancelled",
        desk_2_l2: "Play in the app, or download the MP4",
        desk_2_l3: "Expand any row to review the exact request it was given",
        ...
        faq_1_a: "No. A licence belongs to the machine it was activated on and is held securely by the operating system. There is nothing to sign up for and no password to lose, and the server never learns your name or your email.",
        ...
        faq_3_a: "Yes. Switch the mode to Fixed script and your text is used word for word, one scene per paragraph. Nothing is rewritten, and the word limits stop applying because they only govern generated narration.",
        ...
        faq_5_a: "Yes, on the Bring your own key plan. You can point the app at your own self-hosted image server or at your own OpenAI key; which one it uses is a setting rather than a different build. It also costs far less per video, which is why that plan carries a much larger quota.",
        ...
        ios_feat_sub: "Everything between your sentence and the finished file is handled for you: the script, the artwork direction, the voice, the layout, the music and the final assembly.",
        ...
        pol_sum_1: "GenVideo: Master Tool is published by AIBachKhoa (Son Tran), Vietnam. It turns a topic or a script into a narrated video, and the generation runs on our server rather than on your machine.",
        ...
        pol_contact_1: "AIBachKhoa (Son Tran), Vietnam.",
