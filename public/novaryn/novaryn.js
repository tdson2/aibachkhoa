...
const i18n = {
    en: {
        ...
        ios_stat_waves: "Waves — there is no end screen",
        ios_stat_boss: "Waves between bosses",
        ios_stat_gun: "Gun tiers, each with its own round",
        ios_stat_ships: "Ships to fly",
        ios_stat_ads: "Ads and trackers, anywhere",
        ...
        ios_f2_t: "Twenty gun tiers",
        ios_f2_d: "Every power-up moves you up a rung, and each rung is a different weapon: scatter, piercing lances, plasma that splashes, homing swarms, and a nova cannon at the top.",
        ios_f3_t: "A boss every fifth wave",
        ios_f3_d: "Four waves of formations, then a health bar slides in. A boss throws a pattern you read rather than out-shoot.",
        ...
        ios_iap_skins_d: "Nine ships sold outright, from US$1.99 to US$5.99. Bought once, yours permanently, and restored on a new device with <strong>Restore Purchases</strong> in the shop.",
    ...
    vi: {
        ...
        ios_cta_store: "Sắp có trên App Store",
        ios_cta_shots: "Xem cách chơi",
        ios_meta: "Mã ứng dụng <code>com.tdson.novaryn</code> · dọc màn hình · iPhone và iPad, iOS 15.0 trở lên · không quảng cáo, không theo dõi, chơi offline.",
        ios_stat_waves: "Đợt tấn công — không có màn kết thúc",
        ios_stat_boss: "Số đợt giữa hai lần gặp trùm",
        ios_stat_gun: "Bậc súng, mỗi bậc một loại đạn riêng",
        ios_stat_ships: "Phi thuyền để bay",
        ios_stat_ads: "Quảng cáo và trình theo dõi",
        ios_feat_eyebrow: "Trên iPhone và iPad",
        ios_feat_title: "Kéo để bay. <em>Còn lại là bản lĩnh</em>.",
        ios_feat_sub: "Không nút bắn, không cần joystick, không có menu nào chen giữa bạn và lần chơi kế tiếp. Đặt ngón tay ở đâu thì phi thuyền theo đó, nên cả game chỉ còn một quyết định: đứng ở đâu.",
        ios_f1_t: "Một tay, màn hình dọc",
        ios_f1_d: "Kéo ở bất cứ đâu để lái. Súng tự bắn nên không có gì tranh chỗ với bàn tay đang cầm máy.",
        ios_f2_t: "Hai mươi bậc súng",
        ios_f2_d: "Mỗi vật phẩm nâng một bậc, và mỗi bậc là một khẩu khác hẳn: đạn xoè, giáo xuyên, plasma nổ lan, bầy đạn tự dẫn, và nova cannon ở đỉnh thang.",
        ios_f3_t: "Cứ đợt thứ năm là một trùm",
        ios_f3_d: "Bốn đợt đội hình, rồi một thanh máu trượt vào. Trùm tung ra một hình mẫu để bạn đọc chứ không phải để bắn thắng.",
        ios_f4_t: "Offline, và im lặng",
        ios_f4_d: "Không tài khoản, không đăng nhập, không máy chủ, không quảng cáo, không phân tích. Điểm nằm trên máy. Game không xin bất kỳ quyền nào.",
        ios_iap_eyebrow: "Mua trong ứng dụng",
        ios_iap_title: "Phi thuyền chỉ là lớp sơn. <em>Không bán gì khác</em>.",
        ios_iap_sub: "Mọi khoản mua trong Novaryn đều thuần trang trí. Không vũ khí, đợt chơi, độ khó hay màn nào nằm sau khoản trả tiền, và game vẫn trọn vẹn nếu bạn không tiêu gì. App Store xử lý thanh toán; chúng tôi không bao giờ thấy thông tin thẻ của bạn.",
        ios_iap_skins_t: "Skin phi thuyền — mua một lần",
        ios_iap_skins_d: "Chín phi thuyền bán đứt, từ 1,99 đến 5,99 USD. Mua một lần là của bạn vĩnh viễn, khôi phục trên máy mới bằng <strong>Restore Purchases</strong> trong shop.",
        ios_pro_t: "Novaryn Pro — gói đăng ký tự động gia hạn",
        ios_pro_len: "Thời hạn",
        ios_pro_len_v: "1 tháng, tự động gia hạn",
        ios_pro_price: "Giá",
        ios_pro_price_v: "4,99 USD mỗi tháng, tính theo tiền tệ của bạn",
        ios_pro_what: "Mở khoá gì",
        ios_pro_what_v: "Toàn bộ skin phi thuyền trong shop khi gói còn hiệu lực",
        ios_pro_terms: "Tiền được trừ vào Apple Account khi bạn xác nhận mua. Gói tự động gia hạn trừ khi bạn tắt tự động gia hạn ít nhất 24 giờ trước khi chu kỳ hiện tại kết thúc, và tài khoản bị trừ tiền trong vòng 24 giờ trước thời điểm đó. Quản lý hoặc huỷ tại <strong>Cài đặt → tên bạn → Thuê bao</strong>. Phi thuyền mở nhờ gói sẽ khoá lại khi gói hết hạn; phi thuyền mua đứt vẫn là của bạn.",
        ios_legal_privacy: "Chính sách bảo mật",
        ios_legal_terms: "Điều khoản sử dụng (EULA)",
        ios_shots_eyebrow: "Ảnh chụp màn hình",
        ios_shots_title: "Một ván chơi trông như thế nào",
        ios_support_eyebrow: "Hỗ trợ",
        ios_support_title: "Có người thật trả lời địa chỉ này",
        ios_support_sub: "Thắc mắc, lỗi, hay một khoản mua chưa tới nơi — cứ viết cho chúng tôi. Chúng tôi trả lời trong hai ngày làm việc, bằng tiếng Anh hoặc tiếng Việt.",
        ios_cta_title: "Không có màn kết thúc. Chỉ có bạn đi được bao xa."
    }
};
